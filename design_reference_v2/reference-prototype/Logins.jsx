...
function LoginV1() {
  return (
    <div className="redesign" style={{ width: 1280, height: 820, background: '#F6F9FC', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ width: 420, background: '#fff', borderRadius: 12, padding: 40, boxShadow: '0 15px 35px rgba(10,37,64,0.08), 0 5px 15px rgba(10,37,64,0.05)', border: '1px solid #E3E8EE' }}>
          ...
          {/* SSO */}
          <button style={{ width: '100%', padding: '10px 14px', border: '1px solid #E3E8EE', borderRadius: 6, background: '#fff', fontSize: 13, fontWeight: 500, color: '#0A2540', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, fontFamily: 'inherit', marginBottom: 8 }}>
            <Icon name="google" size={16} stroke={0} /> Continue with Google
          </button>
          <button style={{ width: '100%', padding: '10px 14px', border: '1px solid #E3E8EE', borderRadius: 6, background: '#fff', fontSize: 13, fontWeight: 500, color: '#0A2540', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, fontFamily: 'inherit', marginBottom: 20 }}>
          ...
          <button style={{ width: '100%', padding: '10px 14px', border: 'none', borderRadius: 6, background: '#635BFF', color: '#fff', fontSize: 14, fontWeight: 500, cursor: 'pointer', fontFamily: 'inherit', boxShadow: '0 1px 2px rgba(10,37,64,0.1), inset 0 1px 0 rgba(255,255,255,0.15)' }}>Continue</button>
...
function LoginV2() {
  return (
    <div className="redesign" style={{ width: 1280, height: 820, background: '#fff', display: 'flex' }}>
      {/* Left: brand panel */}
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 40 }}>
        <div style={{ width: 380 }}>
          ...
          <button style={{ width: '100%', padding: '10px 14px', border: 'none', borderRadius: 6, background: '#635BFF', color: '#fff', fontSize: 14, fontWeight: 500, cursor: 'pointer', fontFamily: 'inherit' }}>Sign in</button>
        </div>
      </div>
    </div>
  );
