...
function Dashboard({ initialView = 'map' }) {
  ...
  return (
    <div className="redesign" style={{ width: 1440, height: 900, background: '#F6F9FC', display: 'flex', flexDirection: 'column', overflow: 'hidden', position: 'relative', fontFamily: "'Inter', sans-serif" }}>
